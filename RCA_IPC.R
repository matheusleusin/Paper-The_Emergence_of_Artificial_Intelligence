...
IPC_all_patents_Part5 <- fread("All_patents_and_IPC_codes_Part1.csv", header = F, nrow = c, skip = 80000000)
...
reg_tech9 <- merge(reg_tech3, reg_tech7, all=T, by=c("ctry_code", "Subclass"))
reg_tech9 <- merge(reg_tech9, reg_tech8, all=T, by=c("ctry_code", "Subclass"))

#reg_tech3 <- merge(reg_tech3, reg_tech7, all=T, by=c("ctry_code", "Subclass"))
#reg_tech3 <- merge(reg_tech3, reg_tech8, all=T, by=c("ctry_code", "Subclass"))

#remove the big files
rm(reg_tech4, reg_tech5, reg_tech6, reg_tech7, reg_tech8,)
...
reg_tech3$sum <- rowSums(reg_tech3[,c(3:7)])
reg_tech3 <- reg_tech3[, c((-3), (-4), (-5), (-6), (-7))]
