...
regression_data_renamed <- regression_data %>%
  rename(
    "Country’s techn. rel. dens." = rel_density,
    "Interval " = Period,
...
desired_order_model1_to_3 <- c("`Country’s techn. rel. dens.`", "`Interval `", "`Country `", "`No. of ‘general’ spec.`",
                   "`No. of ‘AI-specific’ spec.`")

# Model 1: Predicting Share_Coinciding with Period fixed effects
model1 <- lm(`Share of ‘break-in’ spec.` ~ `Country’s techn. rel. dens.` + `Interval `, 
             data = regression_data_renamed) 
summary(model1)

model2 <- lm(`Share of ‘break-in’ spec.` ~ `Country’s techn. rel. dens.` + `No. of ‘general’ spec.` + `Interval ` + 
               `No. of ‘AI-specific’ spec.`, 
             data = regression_data_renamed) 
summary(model2)

# Model 3: A simpler model if degrees of freedom are a major concern for Model 2
model3 <- lm(`Share of ‘break-in’ spec.` ~ `Country’s techn. rel. dens.` + `No. of ‘general’ spec.` + `Interval ` + `Country ` + 
               `No. of ‘AI-specific’ spec.`,
             data = regression_data_renamed)
summary(model3)
```
...
```{r, include=FALSE}
newmodel4 <- lm(`No. of sustained ‘break-in’ spec.` ~ `Country’s techn. rel. dens.` + `Interval `+ `No. of sustained ‘general’ spec.` + 
                  `No. of sustained ‘AI-specific’ spec.`, data = regression_data_renamed)
summary(newmodel4)

#Model 5 - persistent break-ins
newmodel5 <- lm(`No. of sustained ‘break-in’ spec.` ~ `Country’s techn. rel. dens.` + `Interval `+ `No. of ‘general’ spec.` + `No. of ‘break-in’ spec.` +
                  `No. of ‘AI-specific’ spec.`, 
                data = regression_data_renamed)
summary(newmodel5)

#Model 6 persistent AI-specific
newmodel6 <- lm(`No. of sustained ‘AI-specific’ spec.` ~ `Country’s techn. rel. dens.` + `Interval `+ `No. of ‘general’ spec.` +
                  `No. of sustained ‘break-in’ spec.`+`No. of ‘break-in’ spec.`+`No. of ‘AI-specific’ spec.`, 
                data = regression_data_renamed)
summary(newmodel6)

desired_order_model4_to_6 <- c("`Country’s techn. rel. dens.`", "`Interval `", 
...
model1_beta <- betareg(`Share of ‘break-in’ spec.` ~ `Country’s techn. rel. dens.` + `Interval `, 
                       data = regression_data_renamed) 
summary(model1_beta)

# Model 2 - adding number of general specialisations
model2_beta <- betareg(`Share of ‘break-in’ spec.` ~ `Country’s techn. rel. dens.` + `No. of ‘general’ spec.` + `Interval ` + 
                         `No. of ‘AI-specific’ spec.`, 
                       data = regression_data_renamed) 
summary(model2_beta)

# Model 3 - controlling for country
model3_beta <- betareg(`Share of ‘break-in’ spec.` ~ `Country’s techn. rel. dens.` + `No. of ‘general’ spec.` + `Interval ` + `Country ` + 
                         `No. of ‘AI-specific’ spec.`,
                       data = regression_data_renamed)
summary(model3_beta)
...
```{r, include=FALSE}
model4_poisson <- glm(`No. of sustained ‘break-in’ spec.` ~ `Country’s techn. rel. dens.` + `Interval `+ `No. of sustained ‘general’ spec.` + 
                        `No. of sustained ‘AI-specific’ spec.`,
...
#Model 5 - persistent break-ins
model5_poisson <- glm(`No. of sustained ‘break-in’ spec.` ~ `Country’s techn. rel. dens.` + `Interval `+ `No. of ‘general’ spec.` + `No. of ‘break-in’ spec.` +
                        `No. of ‘AI-specific’ spec.`, 
                      family = poisson(link = "log"),
                      data = regression_data_renamed)
...
#Model 6 persistent AI-specific
model6_poisson <- glm(`No. of sustained ‘AI-specific’ spec.` ~ `Country’s techn. rel. dens.` + `Interval `+ `No. of ‘general’ spec.` +
                        `No. of sustained ‘break-in’ spec.`+`No. of ‘break-in’ spec.`+`No. of ‘AI-specific’ spec.`, 
                      family = poisson(link = "log"),
                      data = regression_data_renamed)
...
```{r, include=FALSE}
model4_negbin <- glm.nb(`No. of sustained ‘break-in’ spec.` ~ `Country’s techn. rel. dens.` + `Interval `+ `No. of sustained ‘general’ spec.` + 
                          `No. of sustained ‘AI-specific’ spec.`,
                        data = regression_data_renamed)
summary(model4_negbin)

#Model 5 - persistent break-ins
model5_negbin <- glm.nb(`No. of sustained ‘break-in’ spec.` ~ `Country’s techn. rel. dens.` + `Interval `+ `No. of ‘general’ spec.` + `No. of ‘break-in’ spec.` +
                          `No. of ‘AI-specific’ spec.`, 
                        data = regression_data_renamed)
summary(model5_negbin)

#Model 6 persistent AI-specific
model6_negbin <- glm.nb(`No. of sustained ‘AI-specific’ spec.` ~ `Country’s techn. rel. dens.` + `Interval `+ `No. of ‘general’ spec.` +
                          `No. of sustained ‘break-in’ spec.`+`No. of ‘break-in’ spec.`+`No. of ‘AI-specific’ spec.`, 
                        data = regression_data_renamed)
